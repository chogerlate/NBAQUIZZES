...
const pages = ["Home", "Quizz1", "Quizz2"];
const settings = ["Profile", "Account", "Dashboard", "Logout"];

function ResponsiveAppBar() {
  return (
    <>
      <nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 h-auto w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 ">
