          ...
          >
            ...
            <Grid item>
              ...
              >
                ...
                <CardContent>
                  <Typography gutterBottom variant="h5" component="div">
                    ทดสอบ Sense ในการเล่นบาส
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    ในเกมนี้เราจะให้ผู้ใช้งานได้ทำการเล่นเกมตอบคำถาม
                    จากไฮไลท์บาสเกตบอลย้อนหลัง เพื่อวิเคราะห์และใช้เซนส์ในการเล่นบาสของคุณตอบคำถาม โดยจะเป็นไฮไลท์เกี่ยวกับ
                    การทำแต้มและการทำฟาวล์ในเกมบาสเกตบอล
                  </Typography>
                </CardContent>
                <StyledToolbar sx={{ width: "100%" }}>
                  <CardActions>
                      <CustomButtonOutlined variant="contained" size="medium" onClick={()=>{navigate("/Quiz3")}}>
                        เกมตอบคำถามวัด IQ 
                      </CustomButtonOutlined>
                  </CardActions>
                </StyledToolbar>
